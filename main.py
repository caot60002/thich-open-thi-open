...
def check_executor_online(uid):
    try:
        r = requests.get(f"https://cdn.baotu.site/api/status/{uid}", timeout=5)
...
if not os.path.exists("neyoshi"):
    os.makedirs("neyoshi", exist_ok=True)
SERVER_LINKS_FILE = "neyoshi/server-links.txt"
ACCOUNTS_FILE = "neyoshi/accounts.txt"
CONFIG_FILE = "neyoshi/config.json"

version = "2.2.5 | Customized by neyoshi"
...
class Utilities:
    ...
    def format_time_left(time_left):
        ...
        return "{} hour(s) {} minute(s) {} second(s)".format(int(hours), int(minutes), int(seconds))
...
class FileManager:
    SERVER_LINKS_FILE = "neyoshi/server-link.txt"
    ACCOUNTS_FILE = "neyoshi/account.txt"
    CONFIG_FILE = "neyoshi/config-wh.json"
    ...
    def save_server_links(server_links):
        try:
            ...
            print("\033[1;32m[ neyoshi ] - Server links saved successfully.\033[0m")
        except IOError as e:
            print(f"\033[1;31m[ neyoshi ] - Error saving server links: {e}\033[0m")
                ...
                for line in file:
                    ...
                    if line:
                        try:
                            ...
                            print(f"\033[1;31m[ neyoshi ] - Invalid line format: {line}. Expected format 'package,user_id'.\033[0m")
        return accounts
    ...
    def find_userid_from_file(file_path):
        try:
            with open(file_path, 'r') as file:
                ...
                if userid_start == -1:
                    print("\033[1;31m[ neyoshi ] - Userid not found\033[0m")
                    return None

                userid_start += len('"UserId":"')
                userid_end = content.find('"', userid_start)
                if userid_end == -1:
                    print("\033[1;31m[ neyoshi ] - Userid end quote not found\033[0m")
                    return None
            ...
            print(f"\033[1;31m[ neyoshi ] - Error reading file: {e}\033[0m")
            return None
    ...
    def get_username(user_id):
        ...
        for attempt in range(retry_attempts):
            try:
                ...
                print(f"\033[1;31m[ neyoshi ] - Attempt {attempt + 1} failed for Roblox Users API: {e}\033[0m")
        ...
        for attempt in range(retry_attempts):
            try:
                ...
                print(f"\033[1;31m[ neyoshi ] - Attempt {attempt + 1} failed for RoProxy API: {e}\033[0m")
                time.sleep(2 ** attempt)
    ...
    def save_username(user_id, username):
        try:
            ...
            print(f"\033[1;31m[ neyoshi ] - Error saving username: {e}\033[0m")
    ...
    def load_saved_username(user_id):
        try:
            ...
            print(f"\033[1;31m[ neyoshi ] - Error loading username: {e}\033[0m")
            return None
    ...
    def download_file(url, destination, binary=False):
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"\033[1;32m[ neyoshi ] - {os.path.basename(destination)} downloaded successfully.\033[0m")
                return destination
            else:
                error_message = f"Failed to download {os.path.basename(destination)}. Status code: {response.status_code}"
                print(f"\033[1;31m[ neyoshi ] - {error_message}\033[0m")
    ...
    def _load_config():
        ...
        try:
            ...
            print(f"\033[1;31m[ neyoshi ] - Error loading configuration: {e}\033[0m")
    ...
    def save_config():
        ...
        try:
            ...
            print("\033[1;32m[ neyoshi ] - Configuration saved successfully.\033[0m")
        except Exception as e:
            print(f"\033[1;31m[ neyoshi ] - Error saving configuration: {e}\033[0m")
...
class SystemMonitor:
    ...
    def capture_screenshot():
        ...
        try:
            ...
            print(f"\033[1;31m[ neyoshi ] - Error capturing screenshot: {e}\033[0m")
    ...
    def get_memory_usage():
        try:
            ...
            print(f"\033[1;31m[ neyoshi ] - Error getting memory usage: {e}\033[0m")
    ...
    def get_system_info():
        try:
            ...
            print(f"\033[1;31m[ neyoshi ] - Error retrieving system information: {e}\033[0m")
...
class RobloxManager:
    ...
    def get_cookie():
        try:
            ...
            new_dir_path = os.path.join(current_dir, "neyoshi/Shoụko.dev - Data")
            ...
            if not os.path.exists(cookie_txt_path):
                print("\033[1;31m[ neyoshi ] - cookie.txt not found in the current directory!\033[0m")
            ...
            if len(cookies) == 0:
                print("\033[1;31m[ neyoshi ] - No valid cookies found in cookie.txt. Please add cookies.\033[0m")
            ...
            print(f"\033[1;31m[ neyoshi ] - Error: {e}\033[0m")
    ...
    def verify_cookie(cookie_value):
        try:
            ...
            if response.status_code == 200:
                print("\033[1;32m[ neyoshi ] - Cookie is valid! User is authenticated.\033[0m")
                return response.json().get("id", False)
            elif response.status_code == 401:
                print("\033[1;31m[ neyoshi ] - Invalid cookie. The user is not authenticated.\033[0m")
                return False
            else:
    ...
    def get_roblox_packages():
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                print(f"\033[1;31m[ neyoshi ] - Failed to retrieve packages with prefix {package_prefix}.\033[0m")
                Utilities.log_error(f"Failed to retrieve packages with prefix {package_prefix}. Return code: {result.returncode}")
        except Exception as e:
            print(f"\033[1;31m[ neyoshi ] - Error retrieving packages: {e}\033[0m")
    ...
    def kill_roblox_processes(silent=False):
        ...
        for proc in psutil.process_iter(['name', 'cmdline']):
            try:
                ...
                if package_name:
                    ...
                    if not silent:
                        print(f"\033[1;96m[ neyoshi ] - Killing process: {package_name}\033[0m")
                    killed_any = True
        ...
        if not killed_any:
            if not silent:
                print("\033[1;32m[ neyoshi ] - No Roblox processes to kill.\033[0m")
        else:
            time.sleep(2)

    @staticmethod
    def kill_roblox_process(package_name):
        print(f"\033[1;96m[ neyoshi ] - Killing Roblox process for {package_name}...\033[0m")
        try:
            subprocess.run(
            ...
            print(f"\033[1;32m[ neyoshi ] - Killed process for {package_name}\033[0m")
            time.sleep(2)
        except subprocess.CalledProcessError as e:
            print(f"\033[1;31m[ neyoshi ] - Error killing process for {package_name}: {e}\033[0m")
    ...
    def delete_cache_for_package(package_name):
        ...
        if os.path.exists(cache_path):
            ...
            print(f"\033[1;32m[ neyoshi ] - Cache cleared for {package_name}\033[0m")
        else:
            print(f"\033[1;93m[ neyoshi ] - No cache found for {package_name}\033[0m")
    ...
    def inject_cookies_and_appstorage():
        ...
        db_url = "https://cdn.baotu.site/filequantrong/Cookies"
        appstorage_url = "https://cdn.baotu.site/filequantrong/appStorage.json"
        ...
        if not downloaded_db_path or not downloaded_appstorage_path:
            print("\033[1;31m[ neyoshi ] - Failed to download necessary files. Exiting.\033[0m")
        ...
        if not packages:
            print("\033[1;31m[ neyoshi ] - No Roblox packages detected.\033[0m")
            return
        ...
        for package_name in packages:
            try:
                ...
                if not cookie:
                    print(f"\033[1;31m[ neyoshi ] - Failed to retrieve a cookie for {package_name}. Skipping...\033[0m")
                    break

                user_id = RobloxManager.verify_cookie(cookie)
                if user_id:
                    print(f"\033[1;32m[ neyoshi ] - Cookie for {package_name} is valid! User ID: {user_id}\033[0m")
                else:
                    print(f"\033[1;31m[ neyoshi ] - Cookie for {package_name} is invalid. Skipping injection...\033[0m")
                    continue

                print(f"\033[1;32m[ neyoshi ] - Injecting cookie for {package_name}: {cookie}\033[0m")
                ...
                print(f"\033[1;32m[ neyoshi ] - Copied Cookies.db to {destination_db_path}\033[0m")
                ...
                print(f"\033[1;32m[ neyoshi ] - Copied appStorage.json to {destination_appstorage_path}\033[0m")
        ...
        print("\033[1;32m[ neyoshi ] - Opening all Roblox tabs...\033[0m")
        failed_packages = []
        for package_name in packages:
            try:
                print(f"\033[1;36m[ neyoshi ] - Launching {package_name}...\033[0m")
                cmd_splash = [
                    'am', 'start',
                    '-a', 'android.intent.action.MAIN',
                    '-n', f'{package_name}/com.roblox.client.startup.ActivitySplash'
                ...
                if result_splash.returncode != 0:
                    ...
                    print(f"\033[1;32m[ neyoshi ] - Successfully launched {package_name}\033[0m")
            except Exception as e:
        ...
        if failed_packages:
            print(f"\033[1;31m[ neyoshi ] - Failed to launch packages: {', '.join(failed_packages)}\033[0m")
        else:
            print("\033[1;32m[ neyoshi ] - Successfully launched all packages.\033[0m")

        print("\033[1;33m[ neyoshi ] - Waiting for all tabs to load (1 minute)...\033[0m")
        time.sleep(60)

        debug_mode = input("\033[1;93m[ neyoshi ] - Keep Roblox tabs open for debugging? (y/n): \033[0m").strip().lower()
        if debug_mode != 'y':
            print("\033[1;33m[ neyoshi ] - Closing all Roblox tabs after loading...\033[0m")
            RobloxManager.kill_roblox_processes()
            time.sleep(5)
        else:
            print("\033[1;33m[ neyoshi ] - Keeping Roblox tabs open for debugging.\033[0m")

        print("\033[1;32m[ neyoshi ] - Cookie and appStorage injection, followed by app launch, completed for all packages.\033[0m")
    ...
    def format_server_link(input_link):
        if 'roblox.com' in input_link:
            ...
            print("\033[1;31m[ neyoshi ] - Invalid input! Please enter a valid game ID or private server link.\033[0m")
            return None
...
class WebhookManager:
    ...
    def send_webhook():
        ...
        while not stop_webhook_thread:
            try:
                ...
                mem_used = f"{info['memory_used']} GB"
                mem_total = f"{info['memory_total']} GB"
                mem_percent = f"{info['memory_percent']}%"
                uptime = info['uptime']
                ...
                if roblox_processes:
                    ...
                    for proc in roblox_processes:
                        if isinstance(proc, dict):
                            ...
                            roblox_details_list.append(f"{proc_name} (PID: {proc_pid}) | CPU: {proc_cpu}% | RAM: {proc_mem}MB")
                        else:
                    ...
                    roblox_details += f"\n{'─' * 40}\n📊 Total Roblox: CPU {total_roblox_cpu}% | RAM {total_roblox_ram}MB"
                else:
                    roblox_details = "None"
                ...
                embed = {
                    ...
                    "footer": {"text": f"Made with 💖 by neyoshi | Join us at discord.gg/BZ3UYgjUJk",
                            "icon_url": "https://i.imgur.com/5yXNxU4.png"},
                    "timestamp": datetime.now(timezone.utc).isoformat(),
                    "author": {"name": "neyoshi",
                            "url": "https://discord.gg/BZ3UYgjUJk",
                            "icon_url": "https://i.imgur.com/5yXNxU4.png"}
                }
                ...
                with open(screenshot_path, "rb") as file:
                    response = requests.post(
                        webhook_url,
                        data={"payload_json": json.dumps({"embeds": [embed], "username": "neyoshi", "avatar_url": "https://i.imgur.com/5yXNxU4.png"})},
                        files={"file": ("screenshot.png", file)}
                    )

                if response.status_code not in (200, 204):
                    print(f"\033[1;31m[ neyoshi ] - Error sending device info: {response.status_code}\033[0m")
                    Utilities.log_error(f"Error sending webhook: Status code {response.status_code}")

            except Exception as e:
                print(f"\033[1;31m[ neyoshi ] - Webhook error: {e}\033[0m")
    ...
    def setup_webhook():
        ...
        try:
            stop_webhook_thread = True
            webhook_url = input("\033[1;35m[ neyoshi ] - Enter your Webhook URL: \033[0m")
            device_name = input("\033[1;35m[ neyoshi ] - Enter your device name: \033[0m")
            webhook_interval = int(input("\033[1;35m[ neyoshi ] - Enter the interval to send Webhook (minutes): \033[0m"))
            FileManager.save_config()
            stop_webhook_thread = False
            threading.Thread(target=WebhookManager.send_webhook).start()
        except Exception as e:
            print(f"\033[1;31m[ neyoshi ] - Error during webhook setup: {e}\033[0m")
...
class UIManager:
    ...
    def print_header(version):
        console = Console()
        header = Text(r"""
 ________   _______       ___    ___ ________  ________  ___  ___  ___         
|\   ___  \|\  ___ \     |\  \  /  /|\   __  \|\   ____\|\  \|\  \|\  \        
\ \  \\ \  \ \   __/|    \ \  \/  / | \  \|\  \ \  \___|\ \  \\\  \ \  \       
 \ \  \\ \  \ \  \_|/__   \ \    / / \ \  \\\  \ \_____  \ \   __  \ \  \      
  \ \  \\ \  \ \  \_|\ \   \/  /  /   \ \  \\\  \|____|\  \ \  \ \  \ \  \     
   \ \__\\ \__\ \_______\__/  / /      \ \_______\____\_\  \ \__\ \__\ \__\    
    \|__| \|__|\|_______|\___/ /        \|_______|\_________\|__|\|__|\|__|    
                        \|___|/                  \|_________|                  

        """, style="bold yellow")

        config_file = os.path.join("neyoshi", "config.json")
        check_executor = "1"
        global codex_bypass_enabled
        ...
        if os.path.exists(config_file):
            try:
                ...
                console.print(f"[bold red][ neyoshi ] - Error reading {config_file}: {e}[/bold red]")

        console.print(header)
        console.print(f"[bold yellow]- Version: [/bold yellow][bold white]{version}[/bold white]")
        console.print(f"[bold yellow]- Credit: [/bold yellow][bold white]neyoshi[/bold white]")
...
class ExecutorManager:
        ...
        for executor_name, base_path in executors.items():
            ...
            for path in possible_autoexec_paths:
                if os.path.exists(path):
                    ...
                    console.print(f"[bold green][ neyoshi ] - Detected executor: {executor_name}[/bold green]")
                    break
    ...
    def write_lua_script(detected_executors):
        console = Console()
        config_file = os.path.join("neyoshi", "checkui.lua")

        try:
            with open(config_file, "r") as f:
                lua_script_content = f.read()
        except Exception as e:
            console.print(f"[bold red][ neyoshi ] - Error reading config from {config_file}: {e}[/bold red]")
            return
            ...
            if executor_name.upper() == "KRNL":
                ...
                if "check_executor" not in autoruns_data:
                    ...
                    try:
                        ...
                        console.print(f"[bold green][ neyoshi ] - Added script into KRNL autoexec![/bold green]")
                    except Exception as e:
                        console.print(f"[bold red][ neyoshi ] - Error updating KRNL autoexec: {e}[/bold red]")
                        Utilities.log_error(f"Error updating KRNL autoexec: {e}")
                else:
                    console.print(f"[bold green][ neyoshi ] - Script already exists in KRNL autoexec![/bold green]")
                ...
                try:
                    ...
                    lua_written = True
                    console.print(f"[bold green][ neyoshi ] - Lua script written successfully![/bold green]")
                except Exception as e:
                    console.print(f"[bold red][ neyoshi ] - Error writing Lua script to KRNL autoexec: {e}[/bold red]")
            ...
            if not lua_written:
                if executor_name.upper() == "DELTA":
                    ...
                    try:
                        ...
                        lua_written = True
                        console.print(f"[bold green][ neyoshi ] - Lua script written to: {lua_script_path}[/bold green]")
                    except Exception as e:
                        console.print(f"[bold red][ neyoshi ] - Error writing Lua script to {lua_script_path}: {e}[/bold red]")
                ...
                if not lua_written:
                    ...
                    if not lua_written:
                        console.print(f"[bold yellow][ neyoshi ] - No valid path found to write Lua script for {executor_name}[/bold yellow]")
    ...
    def check_executor_status(package_name, continuous=True, max_wait_time=60):
        ...
        while True:
            ...
            if check_executor_online(uid):
                print(f"\033[1;32m[ neyoshi ] - {package_name} is online!\033[0m")
                return True

            if continuous and time.time() > retry_timeout:
                print(f"\033[1;31m[ neyoshi ] - {package_name} timeout after {max_wait_time}s\033[0m")
                return False

            if not notified:
                print(f"\033[1;33m[ neyoshi ] - Waiting for {package_name} to come online...\033[0m")
                notified = True
            ...
            while True:
                ...
                try:
                    ...
                    while time.time() - start_time < 60:
                        # 🔹 gọi check_executor_status mới (đã dùng API)
                    ...
                    if not executor_loaded:
                        ...
                        time.sleep(15)
                        print(f"\033[1;33m[neyoshi] - Rejoining {package_name}...\033[0m")
                    ...
                    RobloxManager.delete_cache_for_package(package_name)
                    time.sleep(10)
                    print(f"\033[1;33m[neyoshi] - Rejoining {package_name} after error...\033[0m")
                    globals()["package_statuses"][package_name]["Status"] = "\033[1;36mRejoining\033[0m"
                    UIManager.update_status_table()
                    RobloxManager.launch_roblox(package_name, server_link)
                    globals()["package_statuses"][package_name]["Status"] = "\033[1;32mJoined Roblox\033[0m"
    ...
    def bypass_thread():
        ...
        while True:
            ...
            try:
                ...
                if not result:
                    print("\033[1;31m[ neyoshi ] - Get Codex key failed. Retrying...\033[0m")
                    time.sleep(5)
                    continue
                    
                expiry_timestamp = result.get("expiry", 0)
                if not expiry_timestamp:
                    print("\033[1;31m[ neyoshi ] - Invalid expiry timestamp. Retrying...\033[0m")
                    time.sleep(5)
                    continue
                ...
                while codex_bypass_enabled:
                    ...
                    if time_left <= 0:
                        print("\033[1;33m[ neyoshi ] - Codex key expired. Restarting...\033[0m")
                        break
                        
                    formatted_time = Utilities.format_time_left(time_left)
                    sys.stdout.write(f"\r\033[1;32m[ neyoshi ] - Codex key expiry in: {formatted_time} ")
                    sys.stdout.flush()
                    time.sleep(1)
                ...
                print(f"\033[1;31m[ neyoshi ] - Error in bypass thread: {e}\033[0m")
                time.sleep(5)
...
class Runner:
    ...
    def launch_package_sequentially(server_links):
        ...
        for package_name, server_link in server_links:
            ...
            if user_id == "Unknown":
                print(f"\033[1;31m[ neyoshi ] - No UserID found for {package_name}, skipping...\033[0m")
                continue
        ...
        for index, (package_name, server_link) in enumerate(packages_to_launch):
            ...
            print(f"\033[1;32m[ neyoshi ] - Launching package {index + 1}/{total_packages}: {package_name}\033[0m")
            try:
                RobloxManager.launch_roblox(package_name, server_link)
                if globals()["check_exec_enable"] == "1":
                    ...
                    if len(detected_executors) > 0:
                        ...
                        print(f"\033[1;33m[ neyoshi ] - No executors detected for {package_name}\033[0m")
            except Exception as e:
                ...
                for package_name, server_link in server_links:
                    ...
                    if not in_game_status[package_name]:
                        ...
                        if is_online:
                            ...
                            print(f"\033[1;32m[ neyoshi ] - {package_name} (UID: {uid}) is now In-Game!\033[0m")
                        else:
                        ...
                        if not is_online:
                            ...
                            if offline_since[package_name] is None:
                                ...
                                with status_lock:
                                    ...
                                    UIManager.update_status_table()
                                print(f"\033[1;31m[ neyoshi ] - {package_name} (UID: {uid}) is Offline! Starting {offline_wait_time}s wait...\033[0m")
                            else:
                                ...
                                if remaining <= 0:
                                    ...
                                    with status_lock:
                                        ...
                                        UIManager.update_status_table()
                                    print(f"\033[1;31m[ neyoshi ] - {package_name} (UID: {uid}) - Wait complete! Rejoining...\033[0m")
                                    ...
                                    print(f"\033[1;33m[ neyoshi ] - {package_name} - Waiting 10s before reopening...\033[0m")
                                    with status_lock:
    ...
    def force_rejoin(server_links, interval, stop_event):
        ...
        while not stop_event.is_set():
            if force_rejoin_interval != float('inf') and (time.time() - start_time >= force_rejoin_interval):
                print("\033[1;31m[ neyoshi ] - Force killing Roblox processes due to time limit.\033[0m")
                RobloxManager.kill_roblox_processes()
                start_time = time.time()
                print("\033[1;33m[ neyoshi ] - Waiting for 5 seconds before starting the rejoin process...\033[0m")
                time.sleep(5)
...
def check_activation_status():
    try:
        response = requests.get("https://cdn.baotu.site/filequantrong/customize", timeout=5)
        response.raise_for_status()
        content = response.text.strip()
        if content == "true":
            print("\033[1;32m[ neyoshi ] - Activation status: Enabled. Proceeding with tool execution.\033[0m")
            return True
        elif content == "false":
            print("\033[1;31m[ neyoshi ] - Activation status: Disabled. Tool execution halted.\033[0m")
            return False
        else:
            print(f"\033[1;31m[ neyoshi ] - Invalid activation status received: {content}. Halting execution.\033[0m")
            Utilities.log_error(f"Invalid activation status: {content}")
            return False
    except requests.RequestException as e:
        print(f"\033[1;31m[ neyoshi ] - Error checking activation status: {e}\033[0m")
...
def main():
    ...
    if not check_activation_status():
        print("\033[1;31m[ neyoshi ] - Exiting due to activation status check failure.\033[0m")
        return
    ...
    if not globals().get("command_8_configured", False):
        globals()["check_exec_enable"] = "1"
        globals()["lua_script_template"] = 'loadstring(game:HttpGet("https://cdn.baotu.site/filequantrong/checkonl+track.lua"))()'
        config_file = os.path.join("neyoshi", "checkui.lua")
        try:
            os.makedirs("neyoshi", exist_ok=True)
            with open(config_file, "w") as f:
                f.write(globals()["lua_script_template"])
            print("\033[1;32m[ neyoshi ] - Default script saved to checkui.lua\033[0m")
        except Exception as e:
            print(f"\033[1;31m[ neyoshi ] - Error saving default script to {config_file}: {e}\033[0m")
            Utilities.log_error(f"Error saving default script to {config_file}: {e}")
        FileManager.save_config()

    if webhook_interval is None:
        print("\033[1;31m[ neyoshi ] - Webhook interval not set, disabled.\033[0m")
        webhook_interval = float('inf')
    if webhook_url and device_name and webhook_interval != float('inf'):
        WebhookManager.start_webhook_thread()
    else:
        print("\033[1;33m[ neyoshi ] - Webhook not configured or disabled.\033[0m")
    ...
    while True:
        ...
        setup_type = input("\033[1;93m[ neyoshi ] - Enter command: \033[0m")
        ...
        if setup_type == "1":
            try:
                ...
                if not globals()["accounts"]:
                    print("\033[1;31m[ neyoshi ] - No user IDs set up.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue
                if not server_links:
                    print("\033[1;31m[ neyoshi ] - No game ID or server link set up.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue

                force_rejoin_input = input("\033[1;93m[ neyoshi ] - Force rejoin interval (minutes, 'q' to skip): \033[0m")
                force_rejoin_interval = float('inf') if force_rejoin_input.lower() == 'q' else int(force_rejoin_input) * 60
                if force_rejoin_interval <= 0:
                    print("\033[1;31m[ neyoshi ] - Interval must be positive.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue
                ...
                if codex_bypass_active and codex_bypass_enabled:
                    print("\033[1;32m[ neyoshi ] - Codex bypass enabled.\033[0m")
            ...
            try:
                print("\033[1;32m[ neyoshi ] - Auto Setup User IDs from appStorage.json...\033[0m")
                packages = RobloxManager.get_roblox_packages()
                accounts = []
                ...
                for package_name in packages:
                    ...
                    try:
                        ...
                        if user_id and user_id != "-1":
                            ...
                            print(f"\033[96m[ neyoshi ] - Found UserId for {package_name}: {user_id}\033[0m")
                        else:
                            print(f"\033[1;31m[ neyoshi ] - UserId not found for {package_name}.\033[0m")
                    except Exception as e:
                        print(f"\033[1;31m[ neyoshi ] - Error reading file for {package_name}: {e}\033[0m")
                        Utilities.log_error(f"Error reading appStorage.json for {package_name}: {e}")

                if accounts:
                    FileManager.save_accounts(accounts)
                    print("\033[1;32m[ neyoshi ] - User IDs saved!\033[0m")
                else:
                    print("\033[1;31m[ neyoshi ] - No User IDs found.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue

                print("\033[93m[ neyoshi ] - Select game:\033[0m")
                games = [
                ...
                choice = input("\033[93m[ neyoshi ] - Enter choice: \033[0m").strip()
                game_ids = {
                ...
                if choice in game_ids:
                    ...
                    server_link = input("\033[93m[ neyoshi ] - Enter game ID or private server link: \033[0m")
                else:
                    print("\033[1;31m[ neyoshi ] - Invalid choice.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue
                ...
                if formatted_link:
                    ...
                    print("\033[1;32m[ neyoshi ] - Game ID or server link saved!\033[0m")
                else:
                    print("\033[1;31m[ neyoshi ] - Invalid server link.\033[0m")
            except Exception as e:
                print(f"\033[1;31m[ neyoshi ] - Error: {e}\033[0m")
                Utilities.log_error(f"Setup error: {e}")
                input("\033[1;32mPress Enter to return...\033[0m")
            ...
            try:
                ...
                config_choice = input("\033[1;93m[ neyoshi ] - Select check method (1-2, 'q' to keep default): \033[0m").strip()

                if config_choice.lower() == "q":
                    globals()["check_exec_enable"] = "1"
                    globals()["lua_script_template"] = 'loadstring(game:HttpGet("https://cdn.baotu.site/filequantrong/checkonl+track.lua"))()'
                    print("\033[1;32m[ neyoshi ] - Default set: Executor + neyoshi Check\033[0m")
                elif config_choice == "1":
                    globals()["check_exec_enable"] = "1"
                    globals()["lua_script_template"] = 'loadstring(game:HttpGet("https://cdn.baotu.site/filequantrong/checkonl+track.lua"))()'
                    print("\033[1;32m[ neyoshi ] - Set to Executor + neyoshi Check\033[0m")
                elif config_choice == "2":
                    globals()["check_exec_enable"] = "0"
                    globals()["lua_script_template"] = None
                    print("\033[1;36m[ neyoshi ] - Set to Online Check.\033[0m")
                else:
                    print("\033[1;31m[ neyoshi ] - Invalid choice. Keeping default.\033[0m")
                    globals()["check_exec_enable"] = "1"
                    globals()["lua_script_template"] = 'loadstring(game:HttpGet("https://cdn.baotu.site/filequantrong/checkonl+track.lua"))()'
                ...
                if globals()["lua_script_template"]:
                    try:
                        ...
                        with open(config_file, "w") as f:
                            f.write(globals()["lua_script_template"])
                        print(f"\033[1;36m[ neyoshi ] - Script saved to {config_file}\033[0m")
                    except Exception as e:
                        print(f"\033[1;31m[ neyoshi ] - Error saving script: {e}\033[0m")
                        Utilities.log_error(f"Error saving script to {config_file}: {e}")
                else:
                    if os.path.exists(config_file):
                        try:
                            os.remove(config_file)
                            print(f"\033[1;36m[ neyoshi ] - Removed {config_file} for Online Check.\033[0m")
                        except Exception as e:
                            print(f"\033[1;31m[ neyoshi ] - Error removing {config_file}: {e}\033[0m")
                            Utilities.log_error(f"Error removing {config_file}: {e}")

                globals()["command_8_configured"] = True

                FileManager.save_config()
                print("\033[1;32m[ neyoshi ] - Check method configuration saved.\033[0m")
            except Exception as e:
                print(f"\033[1;31m[ neyoshi ] - Error setting up check method: {e}\033[0m")
            ...
            if codex_bypass_enabled:
                codex_bypass_enabled = False
                print("\033[1;31m[ neyoshi ] - Codex bypass disabled.\033[0m")
            else:
                ...
                if codex_bypass_thread is None or not codex_bypass_thread.is_alive():
                    ...
                    print("\033[1;32m[ neyoshi ] - Codex bypass enabled and thread started.\033[0m")
                else:
                    print("\033[1;32m[ neyoshi ] - Codex bypass already running.\033[0m")
            FileManager.save_config()
            ...
            try:
                ...
                print(f"\033[1;32m[ neyoshi ] - Current package prefix: {current_prefix}\033[0m")
                new_prefix = input("\033[1;93m[ neyoshi ] - Enter new package prefix (or press Enter to keep current): \033[0m").strip()
                
                if new_prefix:
                    globals()["package_prefix"] = new_prefix
                    FileManager.save_config()
                    print(f"\033[1;32m[ neyoshi ] - Package prefix updated to: {new_prefix}\033[0m")
                else:
                    print(f"\033[1;33m[ neyoshi ] - Package prefix unchanged: {current_prefix}\033[0m")
            except Exception as e:
                print(f"\033[1;31m[ neyoshi ] - Error setting package prefix: {e}\033[0m")
            ...
            if not auto_android_id_enabled:
                android_id = input("\033[1;93m[ neyoshi ] - Enter Android ID to spam set: \033[0m").strip()
                if not android_id:
                    print("\033[1;31m[ neyoshi ] - Android ID cannot be empty.\033[0m")
                    input("\033[1;32mPress Enter to return...\033[0m")
                    continue
                ...
                print("\033[1;32m[ neyoshi ] - Auto change Android ID enabled.\033[0m")
            else:
                auto_android_id_enabled = False
                print("\033[1;31m[ neyoshi ] - Auto change Android ID disabled.\033[0m")
            input("\033[1;32mPress Enter to return...\033[0m")
            continue
...
if __name__ == "__main__":
    try:
        ...
        print(f"\033[1;31m[ neyoshi ] - Error during initialization: {e}\033[0m")
